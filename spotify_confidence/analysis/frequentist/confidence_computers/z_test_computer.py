...
class ZTestComputer(object):
    ...
    def _compute_sequential_adjusted_alpha(self, df: DataFrame, final_expected_sample_size_column: str):
        ...
        return Series(
            ...
            .groupby(groups_except_ordinal if len(groups_except_ordinal) > 0 else "n_comparisons")[
